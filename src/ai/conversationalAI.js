    ...
    categorizeQuestion(question) {
        ...
        class ConversationalAI {
            ...
            getFallbackResponse(question, context, category) {
                ...
                // Se chiede specificamente del bot
