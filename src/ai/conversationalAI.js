...
class ConversationalAI {
    async askQuestion(question, context = {}) {
        try {
            ...
            // Aggiungi reminder per continuare la conversazione
            return response + '\n\n💬 _Per continuare a chattare con me usa `/ai-help` con la tua prossima domanda!_';
        } catch (error) {
            errorLogger.logError('ERROR', 'Errore conversational AI', 'CONV_AI_ERROR', error);
            return 'Mi dispiace, c\'è stato un problemino tecnico. Riprova tra un attimo!\n\n💬 _Usa `/ai-help` per fare altre domande!_';
        }
    }
